...
| <a name="input_managedby"></a> [managedby](#input\_managedby) | ManagedBy, eg 'contact@pankajyadavdevops.com' | `string` | `"contact@pankajyadavdevops.com"` | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/pankajyadavdevops/terraform-google-network"` | no |
